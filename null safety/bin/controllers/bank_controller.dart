...
class BankController {
  ...
  bool makeTransfer(
    ...
    if (!verifyId(idReceiver)) {
      throw ReciverIdInvalidException(idReceiver: idReceiver);
    }
    ...
    if (accountSender.balance < amount) {
      throw SenderBalanceLowerThanAmountException(idSender: idSender, balance: accountSender.balance, amount: amount);
    }
